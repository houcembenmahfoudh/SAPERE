...
import chemotaxis.AgentInjectorChemotaxis;
...
public class AgentRead extends SapereAgent {
	private String agentName;
	private String previous;
	private AgentInjectorChemotaxis chemotaxisInjector;

	public AgentRead(String agentName) {
		super(agentName);
	...
	public void onBondAddedNotification(BondAddedEvent event) {
		...
		// if (!event.getBondedLsa().getProperty("chemoDest").equals(null)) {
		// this.addDirectPropagation(event.getBondedLsa().getProperty("previous_gradient").getValue().firstElement());
		// }
